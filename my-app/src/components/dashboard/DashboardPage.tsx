    ...
    return (
        <div>
            ...
            <div className="m-5 w-96">
                <Link to="/qr">
                    <Card cardTitle={'Show QR'} text={'scan QR'}
                          image={'https://img.icons8.com/material-rounded/512/qr-code.png'}></Card>
                </Link>
            </div>
            <div className="justify-center m-5 w-96">
                <Link to="/loan">
                    <Card cardTitle={'View Loan Application'} text={'In this page user can view loan application'}
                          image={'https://img.icons8.com/material-rounded/512/coin-in-hand.png'}></Card>
                </Link>
            </div>
            <div className="justify-center m-5 w-96">
                <Link to="/transaction">
                    <Card cardTitle={'Make Transaction (Demo)'} text={'In this page user can make transaction'}
